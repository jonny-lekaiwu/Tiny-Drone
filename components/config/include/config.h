...
#error "TINY_DRONE_MINI hardware with ESP32C3 onboard"
#define CONFIG_USING_CAMERA 0
#endif 
#define CONFIG_USING_CAMERA 0
#endif
...
#define CRTP_RX_TASK_STACKSIZE        (5 * configBASE_STACK_SIZE)
#else
...
#define INFO_TASK_STACKSIZE           (4 * configBASE_STACK_SIZE)
