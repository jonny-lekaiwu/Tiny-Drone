...
#else
#define MOT_PWM_CH1  1      // Motor M1 pwmchannel
#define MOT_PWM_CH2  2      // Motor M2 pwmchannel
#define MOT_PWM_CH3  3      // Motor M3 pwmchannel
#define MOT_PWM_CH4  4      // Motor M4 pwmchannel   
#endif
...
/** Short motor melodies used to identify automatically selected flight modes. */
