...
#define CONFIG_USING_GPIO_REG     1

#define I2C_NO_INTERNAL_ADDRESS   0xFFFF

/* Two ESP32-S3 hardware controllers plus one GPIO software bus for SCCB. */
#define I2C_LOGICAL_BUS_COUNT     3
#define I2C_SW_CAMERA_PORT        ((i2c_port_t)2)
...
typedef struct {
    const I2cDef *cfg;                    //< Definition of the i2c
    SemaphoreHandle_t isBusFreeMutex;     //< Mutex to protect buss
    i2c_master_bus_handle_t bus_handle; 
    i2c_master_dev_handle_t dev_handle[128];
    volatile bool is_sw_i2c; 
...
extern i2c_master_dev_handle_t i2cdrvGetDevice(I2cDrv *i2c,uint8_t addr);
